 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --bpp 4 --size 80 --no-compress --stride 1 --align 1 --font bootstrap-icons.woff --range 63202,62218,62166,62979,63203 --format lvgl -o bootstrap_icons_80.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x7, 0xff, 0xff, 0xff, 0xea, 0xaa, 0xaa, 0xaa,
    0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
    0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
    0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
    0xaa, 0xaa, 0xaa, 0xad, 0xff, 0xff, 0xff, 0x70,
    ...
    0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33,
    0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x33,
    0x33, 0x33, 0x32, 0x20, 0x0, 0x0, 0x0, 0x0,
    ...
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x5e, 0xff, 0xff, 0xf1,
    0x7, 0xff, 0xff, 0xff, 0xea, 0xaa, 0xaa, 0xaa,
    0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
    0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
    0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1280, .box_w = 80, .box_h = 80, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3200, .adv_w = 1280, .box_w = 80, .box_h = 71, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 6040, .adv_w = 1280, .box_w = 80, .box_h = 70, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 8840, .adv_w = 1280, .box_w = 80, .box_h = 71, .ofs_x = 0, .ofs_y = 4},
    {.bitmap_index = 11680, .adv_w = 1280, .box_w = 80, .box_h = 52, .ofs_x = 0, .ofs_y = 14}
};
...
{
    {
        .range_start = 62166, .range_length = 1038, .glyph_id_start = 1,
